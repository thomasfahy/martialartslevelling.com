export async function updateUserStats(statChanges, xpPerStat = 100) {
    ...
    try {
      ...
      if (updatedStats.current_xp >= updatedStats.xp_to_next_level) {
        ...
        updatedStats.current_xp -= updatedStats.xp_to_next_level; // Reset current xp to 0 after level up
        updatedStats.xp_to_next_level = updatedStats.xp_to_next_level * 1.2; // Increase xp required for next level (20% increase, adjust as needed)
      }
